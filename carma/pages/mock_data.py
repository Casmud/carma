    ...
    def add_company_data(self) -> None:
        ...
        with open('assets/mock_company_data.csv', 'r') as file:
            ...
            for row in reader:
                ...
                Company.add_company(name=name, address=address, is_garage=is_garage,
    ...
    def add_fuel_data(self) -> None:
        ...
        with open('assets/mock_fuel_data.csv', 'r') as file:
            ...
            for row in reader:
                ...
                Fuel.add_fuel_record(date=date, milage=milage, liters=liters, price=price,
                                                       company=company_id)
